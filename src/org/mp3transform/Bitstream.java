...
public final class Bitstream {
	...
	boolean isSyncCurrentPosition(int syncMode) throws IOException {
		...
		int headerString = ((syncBuffer[0] << 24) & 0xFF000000) | ((syncBuffer[1] << 16) & 0x00FF0000)
				| ((syncBuffer[2] << 8) & 0x0000FF00) | ((syncBuffer[3] << 0) & 0x000000FF);
		try {
	...
	int syncHeader(byte syncMode) throws IOException {
		...
		headerString = ((syncBuffer[0] << 16) & 0x00FF0000) | ((syncBuffer[1] << 8) & 0x0000FF00)
