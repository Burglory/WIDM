...
final class SynthesisFilter {
	...
	private void computePcmSamples0() {
		...
		for (int i = 0; i < 32; i++) {
			...
			double pcmSample = (((vp[0 + dvp] * dp[0]) + (vp[15 + dvp] * dp[1]) + (vp[14 + dvp] * dp[2])
	...
	private void computePcmSamples1() {
		...
		for (int i = 0; i < 32; i++) {
			final double[] dp = D16[i];
			double pcmSample = (((vp[1 + dvp] * dp[0]) + (vp[0 + dvp] * dp[1]) + (vp[15 + dvp] * dp[2])
	...
	private void computePcmSamples2() {
		...
		for (int i = 0; i < 32; i++) {
			final double[] dp = D16[i];
			double pcmSample = (((vp[2 + dvp] * dp[0]) + (vp[1 + dvp] * dp[1]) + (vp[0 + dvp] * dp[2])
	...
	private void computePcmSamples3() {
		...
		for (int i = 0; i < 32; i++) {
			final double[] dp = D16[i];
			double pcmSample = (((vp[3 + dvp] * dp[0]) + (vp[2 + dvp] * dp[1]) + (vp[1 + dvp] * dp[2])
	...
	private void computePcmSamples4() {
		...
		for (int i = 0; i < 32; i++) {
			final double[] dp = D16[i];
			double pcmSample = (((vp[4 + dvp] * dp[0]) + (vp[3 + dvp] * dp[1]) + (vp[2 + dvp] * dp[2])
	...
	private void computePcmSamples5() {
		...
		for (int i = 0; i < 32; i++) {
			final double[] dp = D16[i];
			double pcmSample = (((vp[5 + dvp] * dp[0]) + (vp[4 + dvp] * dp[1]) + (vp[3 + dvp] * dp[2])
	...
	private void computePcmSamples6() {
		...
		for (int i = 0; i < 32; i++) {
			final double[] dp = D16[i];
			double pcmSample = (((vp[6 + dvp] * dp[0]) + (vp[5 + dvp] * dp[1]) + (vp[4 + dvp] * dp[2])
	...
	private void computePcmSamples7() {
		...
		for (int i = 0; i < 32; i++) {
			final double[] dp = D16[i];
			double pcmSample = (((vp[7 + dvp] * dp[0]) + (vp[6 + dvp] * dp[1]) + (vp[5 + dvp] * dp[2])
	...
	private void computePcmSamples8() {
		...
		for (int i = 0; i < 32; i++) {
			final double[] dp = D16[i];
			double pcmSample = (((vp[8 + dvp] * dp[0]) + (vp[7 + dvp] * dp[1]) + (vp[6 + dvp] * dp[2])
	...
	private void computePcmSamples9() {
		...
		for (int i = 0; i < 32; i++) {
			final double[] dp = D16[i];
			double pcmSample = (((vp[9 + dvp] * dp[0]) + (vp[8 + dvp] * dp[1]) + (vp[7 + dvp] * dp[2])
	...
	private void computePcmSamples10() {
		...
		for (int i = 0; i < 32; i++) {
			final double[] dp = D16[i];
			double pcmSample = (((vp[10 + dvp] * dp[0]) + (vp[9 + dvp] * dp[1]) + (vp[8 + dvp] * dp[2])
	...
	private void computePcmSamples11() {
		...
		for (int i = 0; i < 32; i++) {
			final double[] dp = D16[i];
			double pcmSample = (((vp[11 + dvp] * dp[0]) + (vp[10 + dvp] * dp[1]) + (vp[9 + dvp] * dp[2])
	...
	private void computePcmSamples12() {
		...
		for (int i = 0; i < 32; i++) {
			final double[] dp = D16[i];
			double pcmSample = (((vp[12 + dvp] * dp[0]) + (vp[11 + dvp] * dp[1]) + (vp[10 + dvp] * dp[2])
	...
	private void computePcmSamples13() {
		...
		for (int i = 0; i < 32; i++) {
			final double[] dp = D16[i];
			double pcmSample = (((vp[13 + dvp] * dp[0]) + (vp[12 + dvp] * dp[1]) + (vp[11 + dvp] * dp[2])
	...
	private void computePcmSamples14() {
		...
		for (int i = 0; i < 32; i++) {
			final double[] dp = D16[i];
			double pcmSample = (((vp[14 + dvp] * dp[0]) + (vp[13 + dvp] * dp[1]) + (vp[12 + dvp] * dp[2])
	...
	private void computePcmSamples15() {
		...
		for (int i = 0; i < 32; i++) {
			final double[] dp = D16[i];
			double pcmSample = (((vp[15 + dvp] * dp[0]) + (vp[14 + dvp] * dp[1]) + (vp[13 + dvp] * dp[2])
